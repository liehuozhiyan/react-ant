...
export default ({fetchMock, delay, mock, toSuccess, toError}) => {
  return {
    ...
    '/cdmsA/crud/bathDelete': (options) => toSuccess({options}, 400),
    '/cdmsA/crud/getWorkEmployee': (options) => mock({
      'status': true,
      'data|10': [{
        'key|+1': 1,
        'title': '@cname',
    ...
    '/cdmsA/crud/save': (options) => toSuccess({options}, 800),
  }
}